 ...
 * on 2013-09-13 at 09:04:18 UTC 
 * Modify at your own risk.
 */

package com.appspot.dark_safeguard_335.helloworld;
...
public class Helloworld extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.16.0-rc of the helloworld library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://dark-safeguard-335.appspot.com/_ah/api/";
  ...
  public class Greetings {
    ...
    /**
     * Create a request for the method "greetings.message".
     *
     ...
     * @return the request
     */
    public Message message(java.lang.Integer id) throws java.io.IOException {
      Message result = new Message(id);
      initialize(result);
      return result;
    }

    public class Message extends HelloworldRequest<com.appspot.dark_safeguard_335.helloworld.model.HelloGreeting> {
       ...
       * @since 1.13
       */
      protected Message(java.lang.Integer id) {
        super(Helloworld.this, "GET", REST_PATH, null, com.appspot.dark_safeguard_335.helloworld.model.HelloGreeting.class);
      ...
      public Message setId(java.lang.Integer id) {
        this.id = id;
        return this;
      }
     ...
     *
     * @param times
     * @param content the {@link com.appspot.dark_safeguard_335.helloworld.model.HelloGreeting}
     * @return the request
     */
    public Multiply multiply(java.lang.Integer times, com.appspot.dark_safeguard_335.helloworld.model.HelloGreeting content) throws java.io.IOException {
      Multiply result = new Multiply(times, content);
      initialize(result);
      return result;
    }

    public class Multiply extends HelloworldRequest<com.appspot.dark_safeguard_335.helloworld.model.HelloGreeting> {

      private static final String REST_PATH = "multiply";
       ...
       * @since 1.13
       */
      protected Multiply(java.lang.Integer times, com.appspot.dark_safeguard_335.helloworld.model.HelloGreeting content) {
        super(Helloworld.this, "POST", REST_PATH, content, com.appspot.dark_safeguard_335.helloworld.model.HelloGreeting.class);
